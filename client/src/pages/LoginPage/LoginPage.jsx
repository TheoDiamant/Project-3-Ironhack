...
function LoginPage() {
  ...
  <div className="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="email" value={email} onChange={handleEmail} type="text" className="input_field" id="email_field"/>
  </div>
  <div className="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="password" type="password" value={password} onChange={handlePassword} className="input_field" id="password_field"/>
  </div>
