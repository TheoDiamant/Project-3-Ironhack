      ...
      <div className="loginFormDiv">
        ...
        <form className="loginForm" onSubmit={handleLoginSubmit}>
          ...
          <div className="loginInputDiv">
            <label className="loginInputLabel" htmlFor="email_field">Email</label>
            ...
            <input placeholder="name@mail.com" name="email" value={email} onChange={handleEmail} type="text" className="loginInput" id="email_field"/>
          </div>
          ...
          <div className="loginInputDiv">
            ...
            <input placeholder="Password" name="password" type="password" value={password} onChange={handlePassword} className="loginInput" id="password_field"/>
          </div>
