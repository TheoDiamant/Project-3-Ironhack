...
function LoginPage() {
  ...
  return (
    ...
    {/* <form className="authForm" onSubmit={handleLoginSubmit}>
      ...
      <form onSubmit={handleLoginSubmit} class="form_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="password" type="password" value={password} onChange={handlePassword} class="input_field" id="password_field"/>
  </div>
