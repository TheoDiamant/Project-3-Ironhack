...
function SignupPage() {
  ...
  return (
    ...
    <div class="form">
      ...
      <form onSubmit={handleSignupSubmit} class="form_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="John Doe" title="Inpit title" name="name"  value={name} onChange={handleName} type="text" class="input_field" id="email_field"/>
  </div>
  <div class="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="email"  value={email} onChange={handleEmail} type="text" class="input_field" id="email_field"/>
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="input-name" type="password" value={password} onChange={handlePassword} class="input_field" id="password_field"/>
  </div>
