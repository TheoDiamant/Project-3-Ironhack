      ...
      <div className="signupFormDiv">
        ...
        <form className="signupForm" onSubmit={handleSignupSubmit}>
          ...
          <div className="signupInputDiv">
            <label className="signupInputLabel" htmlFor="email_field">Email</label>
            ...
            <input placeholder="name@mail.com" name="email" value={email} onChange={handleEmail} type="text" className="signupInput" id="email_field"/>
          </div>
          ...
          <div className="signupInputDiv">
            ...
            <input placeholder="Password" name="password" type="password" value={password} onChange={handlePassword} className="signupInput" id="password_field"/>
          </div>
